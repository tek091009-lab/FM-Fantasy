...
must(js.includes("news-aesthetic-v35-full-width-parent-grid"),'v35 version missing');
...
must(idx.includes('./newsaestheticv34.js?v=2'),'cache-busted layout missing');
must(idx.includes('fm-deploy-v35-news-full-width-parent-grid'),'v35 marker missing');
console.log('V35 News parent-layout regression passed');
