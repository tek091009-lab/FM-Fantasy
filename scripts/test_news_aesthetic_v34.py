...
assert 'fm-deploy-v38-initial-squad-draft-restore' in idx
print('News v36 presentation regression retained under V38 loader: full-width six-card grid plus one stable No changes this import empty state')
