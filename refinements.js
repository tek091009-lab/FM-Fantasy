(()=>{
  ...
  function loadMobileLayer(){if(document.querySelector('script[data-fm-mobile]'))return;const s=document.createElement('script');s.src='./mobile.js?v=2';s.dataset.fmMobile='true';document.head.appendChild(s)}
