(function(){
  ...
  const css=`
    ...
    @media(max-width:900px){
      ...
      .pitchCard>.pitchScroll,.starPitchCard>.pitchScroll{display:block!important;width:100%!important;max-width:100%!important;height:auto!important;min-height:0!important;overflow-x:auto!important;overflow-y:hidden!important;overscroll-behavior-inline:contain;scrollbar-width:thin;-webkit-overflow-scrolling:touch}
      .pitchCard>.pitchScroll>.pitch,.starPitchCard>.pitchScroll>.pitch,#txPitch{width:760px!important;min-width:760px!important;max-width:none!important;height:610px!important;min-height:610px!important;margin:0!important}
  ...
  function boot(){
    ...
    new MutationObserver(updateTitle).observe(document.body,{subtree:true,attributes:true,attributeFilter:['class']});
    updateTitle();
  }
